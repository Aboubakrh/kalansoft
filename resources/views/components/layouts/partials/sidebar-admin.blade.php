...
<flux:navlist.group expandable heading="Scolarité" class="mt-2">
...
<flux:navlist.group expandable heading="Pédagogie" class="mt-2">
...
<flux:navlist.item icon="users" href="{{ route('admin.rh.index') }}" :current="request()->routeIs('admin.rh.*')">Ressources Humaines</flux:navlist.item>
