<div>
    <div class="flex-1 p-4 md:p-6 xl:p-8 overflow-y-auto no-scrollbar">
        <header class="flex justify-between items-center mb-6">
            <div>
                <h2 class="font-headline-lg text-[24px] text-primary">Modifier la Salle</h2>
                <p class="font-body-lg text-secondary mt-1">Modifiez les informations de la salle {{ $nom }}.</p>
            </div>
