<div>
    <div class="flex-1 p-4 md:p-6 xl:p-8 overflow-y-auto no-scrollbar">
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <header class="mb-8">
                <h2 class="font-headline-lg text-[24px] text-primary">Mes Notes & Bulletins</h2>
                <p class="font-body-lg text-secondary mt-1">Consultez vos résultats scolaires.</p>
            </header>
            ...
            @if($this->inscriptionActive)
                ...
                <div class="mb-10">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-xl font-semibold text-primary">Mes Bulletins Périodiques</h3>
                    </div>
                            ...
                            @foreach($this->periodes as $periode)
                                <flux:card class="p-6 flex flex-col justify-between hover:shadow-md transition-shadow">
                                    <div>
                                        ...
                                        <p class="text-sm text-secondary mb-6">Téléchargez votre bulletin officiel au format PDF.</p>
                                    </div>
                                    <flux:button variant="primary" icon="arrow-down-tray" class="w-full" href="{{ route('parent.bulletins.download', ['inscription' => $this->inscriptionActive->id, 'periode' => $periode]) }}" target="_blank">
                                        Télécharger
                                    </flux:button>
                                </flux:card>
                            @endforeach
                    ...
                    @else
                        <flux:card class="p-8 text-center bg-gray-50 border-gray-200">
                            ...
                            <p class="text-secondary">Aucun bulletin n'est encore disponible pour le moment.</p>
                        </flux:card>
                    @endif
                </div>
                ...
                <div>
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-xl font-semibold text-primary">Mon Relevé de Notes</h3>
                    </div>
                    ...
                    @else
                        <flux:card class="p-12 text-center bg-gray-50 border-gray-200">
                            ...
                            <p class="text-secondary">Aucune note n'a été saisie pour vous pour le moment.</p>
                        </flux:card>
                    @endif
                </div>
            @else
