<div>
    <div class="flex-1 p-4 md:p-6 xl:p-8 overflow-y-auto no-scrollbar">
        <header class="flex justify-between items-center mb-6">
            <div>
                <h2 class="font-headline-lg text-[24px] text-primary">Ajouter une Classe</h2>
                <p class="font-body-lg text-secondary mt-1">Renseignez les informations de la nouvelle classe.</p>
            </div>
        ...
        <flux:card class="p-6">
            <form wire:submit="save" class="space-y-4">
                ...
                <div class="flex mt-6 space-x-2">
                    ...
                    <flux:button type="submit" variant="primary">Ajouter la Classe</flux:button>
                </div>
            </form>
        </flux:card>
    </div>
