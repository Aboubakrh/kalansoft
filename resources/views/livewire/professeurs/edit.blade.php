<div>
    <div class="flex-1 p-4 md:p-6 xl:p-8 overflow-y-auto no-scrollbar">
        <header class="flex justify-between items-center mb-6">
            <div>
                <h2 class="font-headline-lg text-[24px] text-primary">Modifier le Professeur</h2>
                <p class="font-body-lg text-secondary mt-1">Mettez à jour le profil de {{ $prenom }} {{ $nom }}.</p>
            </div>
        ...
        <flux:card class="p-6">
            <form wire:submit="save" class="space-y-6">
                <div>
                    ...
                    <div class="mt-4">
                        <flux:input wire:model="password" type="text" label="Nouveau Mot de passe (Laissez vide pour ne pas modifier)" />
                    </div>
                </div>
